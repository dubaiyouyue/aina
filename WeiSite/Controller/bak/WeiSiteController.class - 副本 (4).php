...
class WeiSiteController extends BaseController {
			...
			/*算法*/
				...
				if($codeddd=='ok'){
					...
					$prize_arr = array(
						...
						'7' => array('id' => 8,  'goumai' => $s_tel['egishiwu'],'pic' => $s_tel['egipic'],'text' => $s_tel['egitext'], 'name'=>'egi','num'=>'99','centen'=>$s_tel['egicenten'],'type'=>$s_tel['egitype'],'v' => $s_tel['egigailv']*1000000),
					);
					//dump($prize_arr);
	...
	function tjdaoccwwjll($leix,$texx){
		...
		$fd['uid']=$user['id'];
		$fd['bank_type']=$texx;
		if(!$_SESSION['new_Total_fee']) $fd['bank_type']='奖品兑换';
		$fd['ok']=1;
    ...
    function postData($url, $data){      
        ...
        curl_setopt($ch, CURLOPT_REFERER, "http://qq.com/");   //构造来路    
	...
	*/
	...
	function mflqyhq(){
		...
		header('Location:/index.php?s=/addon/WeiSite/WeiSite/MyCoupons.html');
	}
